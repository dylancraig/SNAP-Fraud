...
population_path <- "Raw Data/New Jersey/State_Population/New_Jersey_Population.xlsx"
output_dta_path <- "Data Outputs/New Jersey/County_Compiling/New_Jersey_County_Data.dta"
output_excel_path <- "Data Outputs/New Jersey/County_Compiling/New_Jersey_County_Data.xlsx"

# Read the .dta file for New Jersey
NJ <- read_dta(new_jersey_dta_path)

# Read the Excel file for New Jersey population data
...
merged_data <- left_join(NJ, population, by = c("STATE", "LOCALITY", "YEAR"))
